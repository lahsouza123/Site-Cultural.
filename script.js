...
const perguntas = [
    {
        enunciado: "Qual festa cultural vocẽ prefere?",
        alternativas: [ 
            {
                texto: "Festa junina" ,
    ...
    {
        enunciado: "Vocẽ gosta de dançar quadrilha ou reisado?",
        alternativas: [
            {
                texto: "Quadrilha",
                afirmacao: "Trata-se de uma dança coletiva em pares, que possui uma coreogrfia específica baseada em passos tradicionais e um orador, que proclama frases divertidas e determinam os movimentos da dança."
            },
            {
                texto: "Reisado",
